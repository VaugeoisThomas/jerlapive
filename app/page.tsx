      ...
      <Body>
        <main className="flex flex-col m-3 items-center">
          ...
          <div className="flex flex-row justify-between mt-20 gap-2">
            ...
            <Card title="Mes dernières vidéos" id="lastVideo">
              <p className="p-2">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus, tempora nulla accusantium dignissimos eveniet corrupti labore optio. Dicta, porro maxime officia aut sapiente eos, earum nostrum distinctio consectetur minima nihil.
              </p>
            </Card>
          </div>
        </main>
